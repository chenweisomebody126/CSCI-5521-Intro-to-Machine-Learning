function [ newX] = overlap_structure_ondata( traindata,c,l)
...
for t=1:T
    ...
    for image_row=1:Num_step
        for image_col=1:Num_step
     ...
     %manipulating. We save the row index and coloumn index of entries of interest  
            ...
            %through the window_inx,e.g. 1st window of 2*2 in 2nd records should be in position (2,1:4)
            window_idx=sub2ind([Num_step, Num_step], image_row, image_col);
